...
| `ga`     | Goles en contra del equipo local (es decir, goles anotados por el equipo visitante).             |
| `xg`     | Goles Esperados (Expected Goals) a favor del equipo local.                                       |
| `xga`    | Goles Esperados (Expected Goals) en contra del equipo local (es decir, XG del equipo visitante). |
...
| `dist`   | La distancia promedio de los dispar                                                              |
